...
class IntroPanel ( wx.Panel ):
    ...
    def __init__( self, parent ):
        ...
        self.newCreatePatientBtn = wx.Button( self, wx.ID_ANY, u"Create New Patient", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class PatientPanel ( wx.Panel ):
    ...
    def __init__( self, parent ):
        ...
        self.updatePatientBtn = wx.Button( self.notebookProfilePanel, wx.ID_ANY, u"Update Patient", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.simStartBtn = wx.Button( self.sessionNotebookPanel, wx.ID_ANY, u"Start", wx.DefaultPosition, wx.Size( 200,-1 ), 0 )
...
class HistoryPanel ( wx.Panel ):
    ...
    def __init__( self, parent ):
        ...
        self.plotComparisonsBtn = wx.Button( self, wx.ID_ANY, u"Plot Comparisons", wx.DefaultPosition, wx.DefaultSize, 0 )
