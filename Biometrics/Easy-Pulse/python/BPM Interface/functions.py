...
def singleRunPlot(path, minLine, maxLine, meanLine):
	...
	singleRunRawPlot(time, bpm, minLine, maxLine, meanLine)
	singleRunSmoothPlot(time, bpm, minLine, maxLine, meanLine)


def singleRunRawPlot(time, bpm, minLine, maxLine, meanLine):
	fig = plt.gcf()
...
def singleRunSmoothPlot(time, bpm, minLine, maxLine, meanLine):
	numTimes = len(time)
...
if __name__ == '__main__':
    singleRunPlot("writefile.txt", 50, 60, 70)   